...
<body class="font-sans bg-gray-100 text-gray-800 min-h-screen">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-gray-800 text-white p-4">
        <div class="space-y-4">
            <a href="{{ route('organisasi.profilOrganisasi') }}" class="flex items-center space-x-4 p-3 bg-blue-600 rounded-lg">
                <i class="fas fa-user"></i>
                <span>Profil</span>
            </a>
            <a href="{{ route('organisasi.requestDonasiOrganisasi') }}" class="flex items-center space-x-4 p-3 hover:bg-gray-700 rounded-lg">
                ...
                <div class="flex flex-col items-center">
                    <div class="w-32 h-32 bg-gray-200 rounded-full mx-auto mb-4 overflow-hidden">
                        @if($organisasi->foto_organisasi)
                            <img src="{{ asset($organisasi->foto_organisasi) }}" alt="Foto Profil" class="w-full h-full object-cover">
                        @else
