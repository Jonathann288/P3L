   ...
   <div class="p-8 bg-gray-100">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <table class="min-w-full bg-white">
                <thead>
                    <tr>
                        <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-gray-600 text-sm text-left">#</th>
                        <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-gray-600 text-sm text-left">Nama</th>
                        <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-gray-600 text-sm text-left">Jabatan</th>
                        ...
                        <th class="py-3 px-6 bg-gray-200 font-bold uppercase text-gray-600 text-sm text-left">Tanggal Lahir</th>
                    ...
                    @foreach ($pegawai as $index => $p)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">
                                <button onclick="openEditModal({{ $p }})" class="bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600">
                                    Ubah
                                </button>
                            </td>
                        </tr>
    ...
    <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
        <div class="bg-white p-8 rounded-lg w-[500px]">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="mb-4">
                    <label class="block mb-2">No. Telepon</label>
                    <input type="text" id="editTelepon" name="nomor_telepon_pegawai" class="w-full p-2 border rounded" required>
                </div>
                <div class="mb-4">
                    <label class="block mb-2">Tanggal Lahir</label>
                    <input type="date" id="editTanggalLahir" name="tanggal_lahir_pegawai" class="w-full p-2 border rounded" required>
                </div>
                <div class="flex justify-end space-x-2">
    ...
    <script>
        ...
        function openEditModal(pegawai) {
            ...
            document.getElementById('editForm').action = `/DashboardPegawai/update/${pegawai.id}`;
