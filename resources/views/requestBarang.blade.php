    ...
    <div class="flex w-full max-w-5xl rounded-2xl overflow-hidden shadow-lg">
        ...
        <div class="w-1/2 bg-blue-200 p-10">
            ...
            <form action="{{ route('requestBarang.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="tanggal_request" class="block text-sm font-semibold text-gray-700 mb-1">Tanggal
                        Request</label>
                    <input type="date" id="tanggal_request" name="tanggal_request" required
                        class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-600">
                </div>
