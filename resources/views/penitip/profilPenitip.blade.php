...
<body class="font-sans bg-gray-100 text-gray-800 min-h-screen">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-gray-800 text-white p-4">
        <div class="space-y-4">
            ...
            <a href="{{ route('penitip.barang-titipan') }}" class="flex items-center space-x-4 p-3 hover:bg-gray-700 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                ...
                                <span class="block">{{ \Carbon\Carbon::parse($penitip->tanggal_lahir)->format('d F Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
