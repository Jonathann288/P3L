                ...
                <div class="flex flex-col items-center">
                    <div class="w-32 h-32 bg-gray-200 rounded-full mx-auto mb-4 overflow-hidden">
                        @if($pembeli->foto_pembeli)
                            <img src="{{ asset($pembeli->foto_pembeli) }}" alt="Foto Profil" class="w-full h-full object-cover">
                        @else
                    ...
                    <button onclick="toggleEditModal()" class="bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-500 mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                ...
                                <span class="block">{{ \Carbon\Carbon::parse($pembeli->tanggal_lahir)->format('d F Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white p-8 rounded-lg w-full md:w-1/2 lg:w-1/3">
            ...
            <form action="{{ route('pembeli.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end mt-6 space-x-2">
                    <button type="button" onclick="toggleEditModal()" class="bg-gray-500 text-white px-4 py-2 rounded-lg">
                        Batal
                    </button>
