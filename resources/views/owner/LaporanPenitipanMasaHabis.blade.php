                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($data as $row)
                        <tr>
                            ...
                            <td class="px-4 py-2">{{ \Carbon\Carbon::parse($row->tanggal_akhir_penitipan)->format('d-m-Y') }}</td>
                            <td class="px-4 py-2">{{ \Carbon\Carbon::parse($row->tanggal_batas_pengambilan)->format('d-m-Y') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
