            ...
            <tbody class="text-gray-600 text-sm">
                @foreach ($donasiApproved as $index => $donasi)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6">
                            <button onclick="openModal('{{ $donasi['nama_penerima'] }}', '{{ $donasi['tanggal_donasi'] }}', '{{ $donasi['id_request'] }}')" 
    ...
    <div class="bg-white p-6 rounded-lg w-1/3">
        ...
        <form id="editForm" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="date" id="tanggal_donasi" name="tanggal_donasi" class="w-full p-2 border border-gray-300 rounded" required>
            </div>
            <div class="flex justify-end">
                <button type="button" onclick="closeModal()" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded mr-2">Batal</button>
