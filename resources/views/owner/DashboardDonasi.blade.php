    ...
    <div id="donationModal" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center">
        <div class="bg-white w-1/3 rounded-lg shadow-lg p-6">
            ...
            <form id="donationForm" method="POST" action="{{ route('owner.donasi.submit') }}">
                ...
                <div class="mb-4">
                    <label for="tanggal_donasi" class="block text-sm font-medium text-gray-700 mb-1">Tanggal
                        Donasi:</label>
                    <input type="date" id="tanggal_donasi" name="tanggal_donasi" required
                        class="w-full px-4 py-2 border rounded-lg">
                </div>
